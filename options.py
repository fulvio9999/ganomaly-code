...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='cifar10', help='folder | cifar10 | mnist | fashion_mnist ')
        ...
        self.parser.add_argument('--perc_pullation', type=float, default=0, help='Percentuale di contaminazione nel training set. #BYFLV')
        self.parser.add_argument('--count_test', type=float, default=0, help='Numero progressivo da assegnare alle immagini generate nel test set #BYFLV')
        self.parser.add_argument('--class_test', default='Bag', help='Classe da generare nel test set #BYFLV')
    ...
    def parse(self):
        ...
        print(self.opt.perc_pullation)
        self.opt.perc_pullation = self.opt.perc_pullation/1000 
        ...
        expr_dir = os.path.join(self.opt.outf, self.opt.name, str(self.opt.perc_pullation), 'train')
        test_dir = os.path.join(self.opt.outf, self.opt.name, str(self.opt.perc_pullation), 'test')
