...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        self.img_dir = os.path.join(opt.outf, opt.name, str(opt.perc_pullation), 'train', 'images')
        self.tst_img_dir = os.path.join(opt.outf, opt.name, str(opt.perc_pullation), 'test', 'images')
        ...
        # --
        # Log file.
        self.log_name = os.path.join(opt.outf, opt.name, str(opt.perc_pullation), 'loss_log.txt')
